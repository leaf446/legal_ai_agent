...
> **목적**: Legal Evidence Hub 프로젝트의 전체 구조를 이해하고, 각 컴포넌트가 어떻게 연결되는지 파악
...
**Legal Evidence Hub (LEH)**는 이혼 소송을 위한 AI 기반 법률 증거 관리 시스템입니다.
...
*이 문서는 LEH 프로젝트의 아키텍처를 이해하기 위한 시작점입니다. 각 하위 문서를 순서대로 읽으면 전체 그림을 파악할 수 있습니다.*
