  ...
  const [teamMembers] = useState<TeamMember[]>([
    {
      ...
      casesHandled: 45,
      evidenceUploaded: 320,
      activityLevel: 'high',
      lastActive: '2025-11-24T10:30:00'
    },
    {
      id: '2',
      name: '김철수',
      ...
      casesHandled: 38,
      evidenceUploaded: 280,
      activityLevel: 'high',
      lastActive: '2025-11-24T09:15:00'
    },
    {
      id: '3',
      name: '이영희',
      ...
      casesHandled: 25,
      evidenceUploaded: 180,
      activityLevel: 'medium',
      lastActive: '2025-11-23T17:45:00'
    }
  ]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {kpiMetrics.map((metric, index) => (
          <div
            ...
            data-testid={`kpi-${metric.label.replace(/\s+/g, '-').toLowerCase()}`}
          >
            ...
            <div className="flex items-center">
              {metric.trend === 'up' ? (
                ...
                <ArrowDown className="w-4 h-4 text-semantic-error mr-1" />
              )}
              ...
              <div key={index} className="flex items-center">
                ...
                <div className="flex-1 mx-4">
                  <div className="w-full bg-gray-200 rounded-full h-8 relative">
                    <div
                      className="bg-accent h-8 rounded-full flex items-center justify-end pr-3"
                      style={{ width: `${(data.caseCount / maxCaseCount) * 100}%` }}
                    >
            ...
            <tbody>
              {teamMembers
                .sort((a, b) => {
                  ...
                  return levels[b.activityLevel] - levels[a.activityLevel];
                })
                .map((member) => (
                  <tr key={member.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4">
                      <span
                        className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getActivityLevelColor(
